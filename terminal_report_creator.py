    ...
    def validate_license(self):
        ...
        try:
            ...
            with open(self.license_file, "r") as f:
                license_data = json.loads(self.decrypt_data(f.read()))
...
class TreeInventoryApp:
    def __init__(self, root):
        ...
        # Validate license and check for tampering
    ...
    def validate_security(self):
        ...
        try:
            ...
            if not license_valid:
                messagebox.showerror("License Error", license_msg)
                sys.exit(1)
            ...
            messagebox.showerror("Security Error", "Failed to validate security")
            sys.exit(1)
    ...
    def create_footer(self):
        ...
        version_label = tk.Label(
            self.footer_frame,
            text="Tree Inventory - Tree Cutting Terminal Report v1.2 | Created by Ron Michael Comia | © 2025",
            bg="#1E1E1E",
            fg="#888888",
            font=("Arial", 8),
            anchor="w"
    ...
    def find_excel_columns(self, df):
        ...
        species_variations = [
            ...
            'tree type', 'tree kind', 'tree variety'
        ]
        
        # Convert column names to lowercase for comparison
        columns_lower = {col.lower(): col for col in df.columns}
        
        # Find Tree Number column
        tree_number_col = None
        best_tree_score = 0
        for variation in tree_number_variations:
            for col in columns_lower:
                score = fuzz.ratio(variation, col)
                if score > best_tree_score and score >= 80:  # 80% similarity threshold
                    best_tree_score = score
                    tree_number_col = columns_lower[col]
        ...
        for variation in species_variations:
            for col in columns_lower:
                score = fuzz.ratio(variation, col)
                if score > best_species_score and score >= 80:  # 80% similarity threshold
                    best_species_score = score
                    species_col = columns_lower[col]
